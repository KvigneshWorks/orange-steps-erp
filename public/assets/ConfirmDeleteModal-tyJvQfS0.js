import{C as e,D as t,S as n,v as r}from"./index-9Lh4Nivu.js";var i=t(e(),1),a=n(),o=r(),s=480;function c({open:e,title:t=`Delete this record?`,itemName:n,description:r,confirmLabel:c=`Delete`,onConfirm:l,onCancel:u,loading:d=!1}){let f=(0,i.useRef)(null),[p,m]=(0,i.useState)(e),[h,g]=(0,i.useState)(!1),[_,v]=(0,i.useState)(!1);(0,i.useEffect)(()=>{if(e)m(!0),g(!1),v(!1);else if(p){g(!0);let e=setTimeout(()=>m(!1),260);return()=>clearTimeout(e)}},[e]),(0,i.useEffect)(()=>{if(e){let e=e=>{e.key===`Escape`&&u(),e.key===`Enter`&&!d&&!_&&y()};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)}},[e,d,_]);let y=()=>{d||_||(v(!0),setTimeout(l,s))};if(!p)return null;let b=r||(n?`Delete "${n}"? This can be restored later.`:`This record can be restored later from the Recycle Bin.`);return(0,a.createPortal)((0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(`style`,{children:`
        ...
        .cdm-run-figure.falling {
          animation: cdm-run-fall ${s}ms cubic-bezier(0.55,0.06,0.68,0.19) forwards;
        }
      ...
      `}),(0,o.jsx)(`div`,{className:`cdm-backdrop${h?` closing`:``}`,onClick:()=>!_&&u(),children:(0,o.jsxs)(`div`,{className:`cdm-card${h?` closing`:``}`,onClick:e=>e.stopPropagation(),children:[(0,o.jsx)(`div`,{className:`cdm-top-bar`}),(0,o.jsxs)(`div`,{className:`cdm-body`,children:[(0,o.jsx)(`div`,{className:`cdm-run-wrap`,children:(0,o.jsx)(`svg`,{width:`235`,height:`83`,viewBox:`-10 0 235 83`,fill:`none`,style:{overflow:`visible`},children:(0,o.jsx)(`g`,{className:`cdm-run-track${_?` paused`:``}`,children:(0,o.jsx)(`g`,{transform:`translate(25,5)`,children:(0,o.jsxs)(`g`,{className:`cdm-run-flip${_?` paused`:``}`,children:[(0,o.jsxs)(`g`,{className:`cdm-run-lines${_?` falling`:``}`,opacity:`0.4`,stroke:`var(--ember-light,#F5A623)`,strokeWidth:`3.1`,strokeLinecap:`round`,children:[(0,o.jsx)(`line`,{className:`cdm-run-line l1`,x1:`-30`,y1:`32.5`,x2:`-10`,y2:`32.5`}),(0,o.jsx)(`line`,{className:`cdm-run-line l2`,x1:`-25`,y1:`42.5`,x2:`-10`,y2:`42.5`}),(0,o.jsx)(`line`,{className:`cdm-run-line l3`,x1:`-20`,y1:`52.5`,x2:`-10`,y2:`52.5`})]}),(0,o.jsxs)(`g`,{className:`cdm-run-figure${_?` falling`:``}`,children:[(0,o.jsx)(`g`,{transform:`translate(14,22.5)`,children:(0,o.jsxs)(`g`,{className:`cdm-run-arm-back`,children:[(0,o.jsx)(`line`,{x1:`0`,y1:`0`,x2:`-16.3`,y2:`12.5`,stroke:`var(--ember,#FF6B00)`,strokeWidth:`9.4`,strokeLinecap:`round`}),(0,o.jsx)(`circle`,{cx:`-16.3`,cy:`12.5`,r:`4.7`,fill:`var(--ember,#FF6B00)`})]})}),(0,o.jsx)(`g`,{transform:`translate(14,47.5)`,children:(0,o.jsxs)(`g`,{className:`cdm-run-leg-back`,children:[(0,o.jsx)(`line`,{x1:`0`,y1:`0`,x2:`-17.5`,y2:`22.5`,stroke:`var(--ember,#FF6B00)`,strokeWidth:`10.6`,strokeLinecap:`round`}),(0,o.jsx)(`circle`,{cx:`-17.5`,cy:`22.5`,r:`5.4`,fill:`var(--ember,#FF6B00)`})]})}),(0,o.jsx)(`g`,{transform:`rotate(8,14,35)`,children:(0,o.jsx)(`line`,{x1:`14`,y1:`18.8`,x2:`14`,y2:`48.8`,stroke:`var(--ember,#FF6B00)`,strokeWidth:`11.9`,strokeLinecap:`round`})}),(0,o.jsx)(`circle`,{cx:`15`,cy:`8.1`,r:`10.6`,fill:`var(--ember,#FF6B00)`}),(0,o.jsx)(`g`,{transform:`translate(14,47.5)`,children:(0,o.jsxs)(`g`,{className:`cdm-run-leg-front`,children:[(0,o.jsx)(`line`,{x1:`0`,y1:`0`,x2:`18.8`,y2:`20`,stroke:`var(--ember,#FF6B00)`,strokeWidth:`11.3`,strokeLinecap:`round`}),(0,o.jsx)(`circle`,{cx:`18.8`,cy:`20`,r:`5.7`,fill:`var(--ember,#FF6B00)`})]})}),(0,o.jsx)(`g`,{transform:`translate(14,22.5)`,children:(0,o.jsxs)(`g`,{className:`cdm-run-arm-front`,children:[(0,o.jsx)(`line`,{x1:`0`,y1:`0`,x2:`16.3`,y2:`10`,stroke:`var(--ember,#FF6B00)`,strokeWidth:`10`,strokeLinecap:`round`}),(0,o.jsx)(`circle`,{cx:`16.3`,cy:`10`,r:`4.9`,fill:`var(--ember,#FF6B00)`})]})})]})]})})})})}),(0,o.jsx)(`p`,{className:`cdm-line`,children:b})]}),(0,o.jsxs)(`div`,{className:`cdm-footer`,children:[(0,o.jsx)(`button`,{ref:f,className:`cdm-btn-cancel`,onClick:u,disabled:d||_,children:`Cancel`}),(0,o.jsxs)(`button`,{className:`cdm-btn-delete`,onClick:y,disabled:d||_,children:[(d||_)&&(0,o.jsx)(`span`,{className:`cdm-spinner`}),d||_?`Deleting…`:c]})]})]})})]}),document.body)}export{c as t};