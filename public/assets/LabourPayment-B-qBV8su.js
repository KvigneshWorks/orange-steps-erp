import{C as e,D as t,S as n,a as r,b as i,i as a,n as o,o as s,r as c,s as l,t as u,v as d,x as f,y as p}from"./index-9Lh4Nivu.js";import{t as m}from"./ConfirmDeleteModal-tyJvQfS0.js";import{t as h}from"./CalendarDD-BN59z7Pr.js";import{t as g}from"./CreatorBadge-D6HGLrdH.js";var _=t(e(),1),v=n(),y=d(),b=[`linear-gradient(135deg,#60A5FA,#2563EB)`],x={cash:`Cash`,bank_transfer:`Bank Transfer`,upi:`UPI`,cheque:`Cheque`,other:`Other`},ee={cash:`Cash`,upi:`UPI`,bank_transfer:`Bank Transfer`,cheque:`Cheque`,other:`Others`},S=10,C=15;function te(e,t){let n=[];for(let r=1;r<=e;r++)r===1||r===e||Math.abs(r-t)<=1?n.push(r):n[n.length-1]!==`…`&&n.push(`…`);return n}var w={cash:{label:`Cash`,color:`#1E9C6A`,icon:`cash`},upi:{label:`UPI`,color:`#2870CC`,icon:`mobile`},bank_transfer:{label:`Bank Transfer`,color:`#0891B2`,icon:`transfer`},cheque:{label:`Cheque`,color:`#9B45CC`,icon:`document`},other:{label:`Other`,color:`#6B6B6B`,icon:`more`}},ne=`
