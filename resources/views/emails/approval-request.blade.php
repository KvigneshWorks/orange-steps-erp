            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td style="padding:34px 36px 8px;">
                  <table role="presentation" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="background-color:#D8A94E; border-radius:100px; padding:6px 14px;">
                        <span style="font-family:Arial,Helvetica,sans-serif; font-size:11px; font-weight:bold; letter-spacing:1px; color:#0A1530; text-transform:uppercase;">
                          Approval Needed
                        </span>
                      </td>
                    </tr>
              ...
              <tr>
                <td style="padding:14px 36px 0;">
                  <span style="font-family:Arial,Helvetica,sans-serif; font-size:22px; font-weight:bold; color:#FAF6EC; line-height:1.4;">
                    New {{ ucwords(str_replace('_',' ', $req->role)) }} account request
                  </span>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding:8px 36px 26px;">
                  <span style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#B7C0D6; line-height:1.6;">
                    Someone requested access to the ERP. Nothing is created yet — review the details below and approve or reject.
                  </span>
                </td>
              </tr>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:rgba(246,240,228,0.05); border:1px solid rgba(246,240,228,0.14); border-radius:10px;">
                    <tr>
                      <td style="padding:16px 18px;">
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="padding:6px 0; font-family:Arial,Helvetica,sans-serif; font-size:12px; color:#8296C2; width:90px;">Name</td>
                            <td style="padding:6px 0; font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#FAF6EC; font-weight:bold;">{{ $req->name }}</td>
                          </tr>
                          <tr>
                            <td style="padding:6px 0; font-family:Arial,Helvetica,sans-serif; font-size:12px; color:#8296C2;">Email</td>
                            <td style="padding:6px 0; font-family:'Courier New',monospace; font-size:13px; color:#E8E1D2;">{{ $req->email }}</td>
                          </tr>
                          <tr>
                            <td style="padding:6px 0; font-family:Arial,Helvetica,sans-serif; font-size:12px; color:#8296C2;">Role</td>
              ...
              <tr>
                <td style="padding:16px 36px 0;">
                  <span style="font-family:Arial,Helvetica,sans-serif; font-size:12.5px; color:#E4B65B; line-height:1.6;">
                    ⚠️ Super Admin gets full access to every screen and every record in the ERP. Review carefully before approving.
                  </span>
                </td>
              </tr>
              @endif
              ...
              <tr>
                <td align="center" style="padding:28px 36px 8px;">
                  <table role="presentation" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" bgcolor="#D8A94E" style="border-radius:9px;">
