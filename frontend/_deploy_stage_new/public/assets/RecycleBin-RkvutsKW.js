...
.RB-stat:hover { box-shadow:0 18px 36px -12px rgba(30,20,10,.20); }
...
.RB-chip:hover { transform:translateY(-2px); box-shadow:0 6px 14px rgba(30,20,10,.10); }
...
.RB-group:hover { transform:translateY(-3px); box-shadow:0 14px 30px -12px rgba(30,20,10,.16); }
...
.RB-fx-backdrop {
  ...
  display:flex; align-items:center; justify-content:center;
  background:rgba(20,15,10,.34); backdrop-filter:blur(3px); -webkit-backdrop-filter:blur(3px);
}
.RB-fx-card {
  ...
  box-shadow:0 24px 60px -18px rgba(20,15,10,.4), 0 0 0 1px rgba(20,15,10,.05);
}
...
.RB-fx-bar   { position:absolute; left:0; bottom:0; height:3px; width:100%; transform-origin:left; background:linear-gradient(90deg,var(--ember,#ff6b00),var(--ember-light,#f5a623)); }
