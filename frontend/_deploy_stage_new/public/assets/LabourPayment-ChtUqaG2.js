import{C as e,D as t,S as n,a as r,b as i,i as a,n as o,o as s,r as c,s as l,t as u,v as d,x as f,y as p}from"./index-CD8rYwlu.js";import{t as m}from"./ConfirmDeleteModal-jrTMlyGl.js";import{t as h}from"./CalendarDD-B4PfSa8f.js";import{t as g}from"./CreatorBadge-vRLNkHsR.js";var _=t(e(),1),v=n(),y=d(),b=[`linear-gradient(135deg,#F5A623,#E8820A)`],x={cash:`Cash`,bank_transfer:`Bank Transfer`,upi:`UPI`,cheque:`Cheque`,other:`Other`},ee={cash:`Cash`,upi:`UPI`,bank_transfer:`Bank Transfer`,cheque:`Cheque`,other:`Others`},S=10,C=15;function te(e,t){let n=[];for(let r=1;r<=e;r++)r===1||r===e||Math.abs(r-t)<=1?n.push(r):n[n.length-1]!==`…`&&n.push(`…`);return n}var w={cash:{label:`Cash`,color:`#1E9C6A`,icon:`cash`},upi:{label:`UPI`,color:`#2870CC`,icon:`mobile`},bank_transfer:{label:`Bank Transfer`,color:`#0891B2`,icon:`transfer`},cheque:{label:`Cheque`,color:`#9B45CC`,icon:`document`},other:{label:`Other`,color:`#6B6B6B`,icon:`more`}},ne=`
...
.WP-hero {
  background:linear-gradient(135deg,#1a1108 0%,#2d1f08 40%,#1a1108 100%);
...
.WP-hero-icon {
  ...
  background:linear-gradient(135deg,#F5A623,#d98c0a);
  display:flex; align-items:center; justify-content:center;
  box-shadow:0 4px 16px rgba(255,107,0,0.35);
}
.WP-hero-title { font-family:var(--font-body); font-size: 19.5px; font-weight: 800; font-style:normal; color:#c9670c; margin:0 0 2px; }
.WP-hero-sub { font-family:var(--font-mono); font-size: 8px; letter-spacing:2px; color:#8a6a2a; text-transform:uppercase; }
...
.WP-btn-primary { background:linear-gradient(135deg,#F5A623,#d98c0a); color:#fff; position:relative; overflow:hidden; }
...
.WP-btn-primary:hover { transform:translateY(-1px); box-shadow:0 5px 16px rgba(255,107,0,0.4); }
.WP-btn-green { background:linear-gradient(135deg,#F5A623,#E8820A); color:#fff; box-shadow:0 4px 14px rgba(232,130,10,0.32); }
.WP-btn-green:hover { transform:translateY(-2px); box-shadow:0 8px 22px rgba(232,130,10,0.45); }
...
.WP-back-btn:hover { transform:translateY(-1px); border-color:var(--ember-mid); color:var(--ember); box-shadow:0 4px 14px rgba(255,107,0,.2); }
...
.LP-compact thead tr { background:var(--surface-2,#F4E8D7) !important; border-bottom:2px solid var(--ember,#FF6B00) !important; }
.LP-compact th { color:var(--text-3,#3C322A) !important; border-right:1px solid var(--border,#e8e3d9); }
...
.LP-compact tbody tr:nth-child(even) td { background:var(--off-white,#FAFAFA); }
...
/* ── ORANGE UI: exact match with the Master-Data view tables (BioData,
   ...
   Scoped to Labour Payment's view-page tables only, never touches the
   shared .ERP-tbl base elsewhere. ── */
.LP-orange-tbl th { background: var(--surface-2, #F4E8D7) !important; color: var(--text-3, #3C322A) !important; border-bottom: 2px solid var(--ember, #FF6B00) !important; }
...
@keyframes lp-subrow-in {
  0%   { opacity:0; transform:translateY(-8px) scale(.96); background:rgba(255,107,0,0.14); }
...
.LP-row:hover { box-shadow:inset 3px 0 0 var(--ember); background:rgba(255,107,0,0.04); }
...
.LP-pgn-btn:hover:not(:disabled):not(.on) {
  ...
  transform:translateY(-2px) scale(1.05); box-shadow:0 4px 12px rgba(255,107,0,.2);
}
.LP-pgn-btn:active:not(:disabled) { transform:translateY(0) scale(.94); }
.LP-pgn-btn.on {
  background:linear-gradient(135deg,#F5A623,#d98c0a); border-color:transparent; color:#fff;
  box-shadow:0 3px 12px rgba(255,107,0,.38); transform:translateY(-1px);
...
.LP-overlay {
  ...
  background:rgba(15,10,4,.45); backdrop-filter:blur(7px); -webkit-backdrop-filter:blur(7px);
...
.LP-loader-dots span {
  width:5px; height:5px; border-radius:50%; background:#F5A623; display:inline-block;
...
/* ── DETAIL VIEW · PREMIUM WORKER HERO ──
   ...
   other two Labour pages use for their tab switches (Workforce Register's
...
@keyframes lp-avatar-ring { 0%{box-shadow:0 0 0 0 rgba(255,107,0,.4)} 100%{box-shadow:0 0 0 12px rgba(255,107,0,0)} }
.LP-hero {
  position:relative; overflow:hidden;
  background:linear-gradient(135deg,rgba(255,107,0,.10) 0%,var(--white) 45%,rgba(255,107,0,.04) 100%);
...
.LP-hero::before {
  ...
  background:linear-gradient(90deg,var(--ember),#F5A623,#ffd27a,#F5A623,var(--ember));
...
.LP-hero::after {
  ...
  color:rgba(255,107,0,.08); pointer-events:none; line-height:1;
}
.LP-hero-avatar {
...
.LP-chip:hover { transform:translateY(-1px); box-shadow:0 3px 10px rgba(255,107,0,.18); }
...
.WP-panel:hover { box-shadow:0 10px 30px rgba(232,130,10,.09); }
.LP-panel-ico {
  width:26px; height:26px; border-radius:8px; flex-shrink:0;
  background:linear-gradient(135deg,var(--ember-ghost),rgba(255,107,0,0.16)); border:1px solid var(--ember-border);
  display:flex; align-items:center; justify-content:center;
  box-shadow:0 2px 8px rgba(255,107,0,.15);
}
.LP-count-pill {
...
.LP-prog i { display:block; height:100%; border-radius:100px; background:linear-gradient(90deg,#F5A623,#E8820A); transition:width .6s ease; }
...
.LP-step {
  ...
  background:linear-gradient(135deg,#F5A623,#d98c0a); color:#fff;
...
.LP-step-line {
  ...
  font-family:var(--font-mono); font-size: 8px; font-weight: 800;
  letter-spacing:1.5px; text-transform:uppercase; color:#c47a0a;
}
.WP-session { animation:lp-row-in .35s ease both; transition:background .15s; }
.WP-session:hover { background:rgba(255,107,0,.04); }
...
/* ── SEARCHABLE MODE DROPDOWN (Daybook-style) ── */
...
.LP-dd-item:hover { background:rgba(255,107,0,.07); }
...
.LP-dd-list-mode { max-height:170px; padding:5px; scrollbar-width:thin; scrollbar-color:rgba(255,107,0,0.35) transparent; }
...
.LP-dd-list-mode::-webkit-scrollbar-thumb { background:rgba(255,107,0,0.3); border-radius:100px; }
.LP-dd-list-mode::-webkit-scrollbar-thumb:hover { background:rgba(255,107,0,0.5); }
...
.LP-dd-check.checked { border-color:var(--ember); background:linear-gradient(135deg,var(--ember-mid,#fe9307),var(--ember)); }
...
.LP-sync-toggle {
  ...
  text-transform:uppercase; color:#c47a0a; user-select:none;
}
.LP-sync-toggle input { width:15px; height:15px; accent-color:#E8820A; cursor:pointer; margin:0; }
...
.LP-db-warn {
  ...
  background:rgba(201,103,12,.08); border:1px solid rgba(201,103,12,.25); border-radius:8px;
  font-family:var(--font-mono); font-size: 7.5px; font-weight: 700; letter-spacing:.3px;
  color:#92400e;
}
.LP-db-warn button {
  background:none; border:none; padding:0; margin:0; color:#c9670c; font-weight: 800;
...
.WP-tbl th {
  ...
  background:linear-gradient(135deg,var(--ember-mid,#fe9307),var(--ember,#FF6B00)); text-align:center; white-space:nowrap; line-height:1.3;
}
...
.WP-tbl tbody tr:not(.WP-tbl-total):hover td { background:rgba(255,107,0,0.05); }
.WP-tbl tbody tr:not(.WP-tbl-total):hover .WP-tbl-name { color:var(--ember); }
.WP-tbl-name { transition:color .15s; }
.WP-tbl-total { background:rgba(255,107,0,0.04); animation:wp-total-in .3s ease both; }
...
/* ── Sub-worker collapse toggle (sits directly beneath the head worker's
   ...
   pattern used in Workforce Register's Sub Names column. ── */
.LP-subtoggle {
  ...
  font-family:var(--font-mono); font-size: 7.5px; font-weight: 800; letter-spacing:.5px; text-transform:uppercase;
  color:#B34700; cursor:pointer; transition:all .16s ease;
}
.LP-subtoggle svg { transition:transform .18s ease; }
.LP-subtoggle.open svg { transform:rotate(180deg); }
.LP-subtoggle:hover { background:linear-gradient(135deg,var(--ember-mid,#fe9307),var(--ember)); color:#fff; border-color:transparent; }
.LP-subnum {
...
.WP-tbl-section td {
  ...
  font-family:var(--font-mono); font-size: 8px; font-weight: 800; letter-spacing:1px;
  text-transform:uppercase; color:#c9670c; padding:7px 12px; text-align:left;
}
...
.LP-cel-amt-badge {
  ...
  border-radius: 100px;
  font-family: var(--font-mono,'JetBrains Mono',monospace);
  font-size: 15px; font-weight: 800; color: #FF6B00; margin-top: 4px;
  overflow: hidden;
}
...
.LP-step2-head {
  ...
  background:linear-gradient(135deg,rgba(255,107,0,.10),rgba(255,107,0,.04));
  border-bottom:1px solid var(--ember-border); border-radius:9.5px 9.5px 0 0;
  font-family:var(--font-mono); font-size: 7.5px; font-weight: 800;
  letter-spacing:1.2px; text-transform:uppercase; color:#c47a0a;
}
...
.WP-pick-head { display:flex; align-items:center; gap:7px; padding:8px 12px; background:linear-gradient(135deg,rgba(255,107,0,.10),rgba(255,107,0,.04)); border-bottom:1px solid var(--ember-border); font-family:var(--font-mono); font-size: 7.5px; font-weight: 800; letter-spacing:1.2px; text-transform:uppercase; color:#c47a0a; }
...
.WP-pick-link.all {
  background:linear-gradient(135deg,#fe9307,#c9670c); border:1px solid transparent;
  color:#fff; box-shadow:0 2px 8px rgba(255,107,0,.3);
}
.WP-pick-link.all:hover { transform:translateY(-1px) scale(1.03); box-shadow:0 4px 14px rgba(255,107,0,.45); }
.WP-pick-link.none {
...
.WP-pick-tablewrap::-webkit-scrollbar-thumb { background:linear-gradient(180deg,#F5A623,#d98c0a); border-radius:100px; }
...
.WP-pick-table thead th {
  ...
  color:var(--text-3,#3C322A); padding:8px 10px; border-bottom:2px solid var(--ember,#FF6B00);
  background:var(--surface-2,#F4E8D7); text-align:left; white-space:nowrap;
}
...
.WP-pick-table tbody tr:hover { background:rgba(255,107,0,.06); }
.WP-pick-table tbody tr.on { background:linear-gradient(90deg,rgba(255,107,0,.12),rgba(255,107,0,.04)); box-shadow:inset 3px 0 0 var(--ember); }
.WP-pick-table td {
...
.WP-pick-chk:checked { background:linear-gradient(135deg,#F5A623,#d98c0a); border-color:transparent; box-shadow:0 2px 8px rgba(255,107,0,.4); }
...
.LP-pick-prog i { display:block; height:100%; border-radius:100px; background:linear-gradient(90deg,#F5A623,#E8820A); transition:width .45s ease; }
.LP-max-chip {
...
.LP-max-chip:hover:not(:disabled) { background:var(--ember); color:#fff; transform:translateY(-1px); box-shadow:0 3px 10px rgba(255,107,0,.3); }
...
.WP-split-preview {
  ...
  border:1.5px solid rgba(255,107,0,0.32); border-radius:12px; overflow:hidden; margin-top:16px;
  animation:wp-pick-in .3s ease both;
  box-shadow:0 6px 20px rgba(255,107,0,.1);
}
.WP-split-head {
  padding:11px 16px; background:linear-gradient(135deg,#F5A623,#d98c0a); border-bottom:1px solid rgba(255,107,0,0.15);
...
.WP-split-tbl th {
  font-family:var(--font-mono); font-size: 7.5px; font-weight: 800; letter-spacing:1.5px; text-transform:uppercase;
  color:var(--text-4); padding:9px 14px; border-bottom:1px solid rgba(255,107,0,0.15);
  background:rgba(255,107,0,0.05); text-align:left;
}
.WP-split-tbl td { padding:10px 14px; font-family:var(--font-mono); font-size: 9.5px; border-bottom:1px solid rgba(255,107,0,0.1); }
...
.WP-split-bar {
  ...
  border-top:1px solid rgba(255,107,0,0.15); background:rgba(255,107,0,0.08); flex-wrap:wrap;
}
...
.WP-alloc-partial { color:#c47a0a; font-weight: 800; }
...
.LP-alloc-dot.partial { background:#e0a63a; }
...
.WP-loading-dot {
  width:6px; height:6px; border-radius:50%; background:#F5A623; display:inline-block;
  animation:wp-bounce 1s ease-in-out infinite;
}
