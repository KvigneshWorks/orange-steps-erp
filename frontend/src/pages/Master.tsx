                                    ...
                                    {pagedCategories.map((cat, i) => (
                                        <tr key={cat.id}
                                            ...
                                            <td className="ERP-center ERP-nowrap">
                                                <button className="MD-act-ico edit" title="Edit" onClick={() => handleEdit(cat)}>
                                                ...
                                                {canDelete(userRole) && (
                                                    <button className="MD-act-ico delete" title="Delete" onClick={() => handleDelete(cat.id, cat.name)}>
