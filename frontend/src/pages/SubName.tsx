                                            ...
                                            <tr key={sn.id}>
                                                ...
                                                <td className="ERP-center ERP-nowrap">
                                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                                                        <button className="MD-act-ico edit" title="Edit" onClick={() => handleEdit(sn)}>
                                                        ...
                                                        {canDelete(userRole) ? (
                                                            <button className="MD-act-ico delete" title="Delete" onClick={() => handleDelete(sn.id, sn.alternate_name)}>
