...
class ClientProject extends Model
{
    ...
    protected $fillable = [
        'client_id', 'project_name', 'project_type', 'start_date',
        'total_budget', 'description', 'type_notes', 'status', 'created_by',
    ];
    ...
    {
        // Finds the most recent payment that has a future due date set
